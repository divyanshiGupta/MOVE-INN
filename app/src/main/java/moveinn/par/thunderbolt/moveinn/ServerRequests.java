...
public class ServerRequests {
    ...
    public static final String SERVER_ADDRESS = "http://moveinin.site88.net/";
    ...
    public class StoreUserDataAsyncTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... params) {
            ...
            dataToSend.add(new BasicNameValuePair("contactno", user.contactno + ""));
        ...
        protected User doInBackground(Void... params) {
            ...
            try {
                ...
                if (jObject.length() != 0){
                    ...
                    returnedUser = new User(fname,lname, contactno,email, user.username,
                            user.password);
                }
